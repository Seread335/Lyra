...
Fixed version using correct function names
"""
...
# Test cases - FIXED: using toString instead of tostring
test_cases = {
    "arithmetic": """
var sum: i32 = 0
var i: i32 = 0
...
print("String length: " + toString(len))
""",
}
...
def measure_performance(name: str, code: str) -> dict:
    ...
    try:
        ...
        ipc = total_instructions / max(elapsed, 0.001) if elapsed > 0 else 0
...
def main():
    ...
    print("- Higher IPC = better instruction throughput")
    print("- Tree-walking interpreter baseline: ~0.5-2.0 IPC")
    print("- With optimization: ~2.0-4.0 IPC")
    print("- Lyra target: 2.0+ IPC")
    print("="*70)
